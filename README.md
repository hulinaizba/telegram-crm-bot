...
дней (кнопки 1–5 или своё число) прислать в `/today` сигнал 🔔 по этому
...
tests/         — pytest, 108 тестов на фейковой таблице и фейковых Update
...
- `pytest` — 108 unit-тестов без обращения к реальным Telegram/Google API
